    ...
    >
      ...
      <div className="md:pl-20 flex-1 flex flex-col min-h-screen w-full transition-all duration-300 relative z-10">
        ...
        <header className="sticky top-0 z-30 px-4 sm:px-8 py-3 flex items-center justify-between transition-colors duration-300" style={{
          ...
          {/* Right: Live Telemetry, Role Scope & Dark/Light Mode Switch */}
          <div className="flex items-center space-x-2.5 sm:space-x-3">
            {/* Real-time System Status Pill (98,649 WORKS & Ping) */}
            <div className="flex items-center space-x-2 px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl text-xs font-mono transition-all" style={{ background: theme === 'light' ? 'rgba(241,245,249,0.9)' : 'rgba(0,0,0,0.35)', border: theme === 'light' ? '1px solid rgba(203,213,225,0.8)' : '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div className="flex items-center space-x-2 px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl text-xs font-semibold transition-all" style={{ background: 'rgba(139,92,246,0.12)', border: '1px solid rgba(139,92,246,0.28)', color: theme === 'light' ? '#6d28d9' : 'rgba(196,181,253,0.95)' }}>
