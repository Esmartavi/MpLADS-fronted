    ...
    <div className="space-y-6">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="space-y-2">
            <div className="flex items-center space-x-2 flex-wrap">
              ...
              <span className="px-2 py-0.5 text-[10px] font-mono rounded bg-rose-950/60 text-rose-300 border border-rose-800/80">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
        <div className="glass-panel p-4 rounded-xl border border-slate-800 space-y-1">
          ...
          <div className="text-2xl font-bold font-display text-white">{totalCollisions}</div>
          <div className="text-[11px] text-cyan-400 font-mono">Pairs with d ≤ 2</div>
        </div>
        ...
        <div className="glass-panel p-4 rounded-xl border border-rose-900/40 bg-rose-950/10 space-y-1">
          ...
          <div className="text-2xl font-bold font-display text-rose-400">{exactClonesCount}</div>
          <div className="text-[11px] text-rose-400 font-mono">Hamming Distance = 0</div>
        </div>
        ...
        <div className="glass-panel p-4 rounded-xl border border-amber-900/40 bg-amber-950/10 space-y-1">
          ...
          <div className="text-2xl font-bold font-display text-amber-400">2</div>
          <div className="text-[11px] text-amber-300 font-mono">UP & CG Multi-Sanction</div>
        </div>
        ...
        <div className="glass-panel p-4 rounded-xl border border-indigo-900/40 bg-indigo-950/10 space-y-1">
          ...
          <div className="text-2xl font-bold font-display text-indigo-400">₹39.81 L</div>
          <div className="text-[11px] text-indigo-300 font-mono">4 Colliding Projects</div>
        </div>
        ...
        <div className="glass-panel p-4 rounded-xl border border-emerald-900/40 bg-emerald-950/10 space-y-1 col-span-2 lg:col-span-1">
          ...
          <div className="text-2xl font-bold font-display text-emerald-400">120</div>
          <div className="text-[11px] text-emerald-300 font-mono">Photos Analyzed</div>
        </div>
      </div>
      ...
      <div className="glass-panel p-4 rounded-xl border border-slate-800 space-y-3">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 overflow-x-auto w-full lg:w-auto pb-1 lg:pb-0 no-scrollbar">
            ...
            >
              ...
              <span className="text-[10px] font-mono px-1.5 py-0.2 rounded bg-rose-950/80 text-rose-300 border border-rose-800">
        ...
        <div className="flex items-center justify-between text-xs text-slate-400 pt-1 border-t border-slate-800/60">
          <div className="flex items-center gap-3">
            ...
            />
            <span className="font-mono text-cyan-300 font-bold">{similarityThreshold}%+</span>
          </div>
      ...
      {selectedPair && (
        <div className="glass-panel p-5 rounded-2xl border border-cyan-500/40 space-y-4 shadow-2xl relative overflow-hidden bg-navy-950/90">
          ...
          <div className="p-3.5 rounded-xl bg-gradient-to-r from-rose-950/50 via-slate-900/60 to-rose-950/50 border border-rose-800/80 text-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-3 shadow-inner">
            <div className="space-y-1">
              <div className="font-bold text-rose-200 flex items-center gap-2">
                ...
                <span>CROSS-PROJECT ASSET RECYCLING IDENTIFIED</span>
                <span className="px-2 py-0.5 rounded bg-rose-500/30 text-rose-200 font-mono text-[10px] border border-rose-500/50 font-bold">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-slate-900 hover:bg-slate-800 border border-slate-700 text-cyan-300 text-xs font-semibold flex items-center gap-1 transition-all"
              >
              ...
              <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 space-y-3 relative group">
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right font-mono">
                    <div className="text-[10px] text-slate-500 uppercase">Sanction Disbursed</div>
                ...
                <div
                  ...
                  className="relative rounded-xl overflow-hidden border border-slate-800 bg-black/80 aspect-video sm:h-64 flex items-center justify-center cursor-pointer group-hover:border-cyan-500/50 transition-all"
                >
                  <img
                  ...
                  <div className="absolute bottom-2 left-2 px-2 py-0.5 rounded bg-black/80 border border-slate-700 text-[9px] font-mono text-slate-400 truncate max-w-[85%]">
                    {selectedPair.file_1}
                  </div>
                </div>
                ...
                <div className="space-y-2 text-xs">
                  <div className="p-2.5 rounded-lg bg-slate-900/90 border border-slate-800/80">
                    <div className="text-[10px] text-slate-500 uppercase font-semibold">Location / Work Description</div>
                    <div className="text-slate-300 text-[11px] line-clamp-2 mt-0.5">
                      "{selectedPair.description_1 || 'Civil development work'}"
                    </div>
                  </div>

                  <div className="flex items-center justify-between text-[11px] font-mono p-2 rounded-lg bg-slate-900/60 border border-slate-800">
                    <div className="flex items-center gap-1.5 text-slate-400">
                      <Hash className="w-3.5 h-3.5 text-cyan-400" />
                      <span>64-bit DCT pHash:</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-cyan-300 font-bold">{selectedPair.phash_1}</span>
                      <button
              ...
              <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 space-y-3 relative group">
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <div className="flex items-center justify-between text-[11px] font-mono p-2 rounded-lg bg-slate-900/60 border border-slate-800">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-cyan-300 font-bold">{selectedPair.phash_2}</span>
                      <button
              ...
              <div className="flex items-center justify-center gap-3">
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold font-mono transition-all ${
                    toggleActive === 'A'
                      ? 'bg-cyan-500/30 text-cyan-200 border border-cyan-500 shadow-glow-cyan'
          ...
          {copiedHash && (
            <div className="fixed bottom-6 right-6 z-50 px-4 py-2 rounded-xl glass-panel-glow border border-cyan-500 text-xs font-semibold text-cyan-200 shadow-2xl animate-in fade-in">
      ...
      <div className="glass-panel p-5 rounded-2xl border border-slate-800 space-y-4">
              ...
              return (
                <div
                  ...
                  className={`p-3 rounded-xl border transition-all cursor-pointer relative space-y-2.5 ${
                    isSelected
                      ? 'bg-slate-900 border-cyan-500/70 shadow-lg shadow-cyan-950/40 ring-1 ring-cyan-500/40'
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-[10px] text-cyan-400 font-semibold pt-1 border-t border-slate-800/60">
        ...
        {filteredPairs.length > 30 && (
          <div className="p-3 text-center text-xs font-mono text-slate-500 bg-slate-900/40 rounded-xl border border-slate-800">
