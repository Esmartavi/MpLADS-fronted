...
| **Ensemble Precision (CRITICAL+HIGH)** | **76.43%** | Evaluated against ground-truth statutory labels |
| **Ensemble Recall** | **73.93%** | Percentage of statutory violations captured |
| **Ensemble F1 Score** | **75.16%** | Balanced harmonic mean |
